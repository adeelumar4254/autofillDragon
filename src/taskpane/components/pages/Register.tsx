                    ...
                    <Box sx={{ width: "100%", maxWidth: 350 }}>
                        ...
                        <Box sx={{ textAlign: "center", marginBottom: "10px" }}>
                            <Box sx={{
                                ...
                                <img src={Logo} alt="Booking Builder Logo" style={{ width: '100%', objectFit: 'contain',marginBottom:"30px" }} />
                            </Box>
                            <Typography variant="h6" sx={{ fontWeight: 700, color: BRAND_DARK, fontSize: "0.90rem", marginTop: "-23px" }}>
                        ...
                        >
                                ...
                                {activeStep === 0 ? (
                                    <Fade in={activeStep === 0}>
                                        <Box>
                                            ...
                                            <Stack spacing={1}>
                                                <Link href="https://www.bookingbuilder.com" target="_blank" sx={{ display: 'flex', alignItems: 'center', gap: 1.5, fontSize: '0.85rem', textDecoration: 'none', color: BRAND_LIGHT, fontWeight: 700 }}>
                                                    <WebIcon fontSize="small" /> bookingbuilder.com
                                                </Link>
                                                <Link href="mailto:sales@bookingbuilder.com" sx={{ display: 'flex', alignItems: 'center', gap: 1.5, fontSize: '0.85rem', textDecoration: 'none', color: BRAND_LIGHT, fontWeight: 700 }}>
                                                    <EmailIcon fontSize="small" /> sales@bookingbuilder.com
                                                </Link>
                                                <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1.5, fontSize: '0.85rem', color: BRAND_LIGHT, fontWeight: 700 }}>
                            ...
                            <MobileStepper
                                ...
                                nextButton={
                                    <IconButton size="small" onClick={handleNext} sx={{ color: BRAND_LIGHT }}>
                                        <KeyboardArrowRight />
                                    </IconButton>
                                }
                                backButton={
                                    <IconButton size="small" onClick={handleBack} sx={{ color: BRAND_LIGHT }}>
                                        <KeyboardArrowLeft />
                                    </IconButton>
                                }
                            />
